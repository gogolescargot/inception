...
#    Updated: 2024/05/26 22:40:06 by ggalon           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
all:
	@ echo "\n${BBlue}Calling docker compose build...${NC}"
	@ sudo docker compose -f ./containers/docker-compose.yml build
...
stop:
	...
	@ sudo docker compose -f ./containers/docker-compose.yml down
